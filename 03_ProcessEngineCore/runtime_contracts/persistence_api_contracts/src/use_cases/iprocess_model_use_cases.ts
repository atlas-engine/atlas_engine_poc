...
import {ProcessDefinitionFromRepository, ProcessModel} from '../types/index';
...
export interface IProcessModelUseCases {
   ...
   * @throws                   404, if the ProcessModel was not found.
   */
  getProcessModelByProcessInstanceId(identity: IIdentity, processInstanceId: string): Promise<ProcessModel.Process>;
